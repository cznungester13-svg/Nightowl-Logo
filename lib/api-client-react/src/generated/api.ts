...
export const getCreateAdminBillingPortalUrl = () => {




  return `/api/admin/billing-portal`
}

/**
 * @summary Create a Stripe customer portal session
 */
export const createAdminBillingPortal = async ( options?: Parameters<typeof customFetch>[1]): Promise<BillingPortal> => {

  return customFetch<BillingPortal>(getCreateAdminBillingPortalUrl(),
  {
    ...options,
    method: 'POST'
...
export const getCreateAdminBillingPortalMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createAdminBillingPortal>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createAdminBillingPortal>>, TError,void, TContext> => {

const mutationKey = ['createAdminBillingPortal'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createAdminBillingPortal>>, void> = () => {


          return  createAdminBillingPortal(requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateAdminBillingPortalMutationResult = NonNullable<Awaited<ReturnType<typeof createAdminBillingPortal>>>

    export type CreateAdminBillingPortalMutationError = ErrorType<unknown>

    /**
 * @summary Create a Stripe customer portal session
 */
export const useCreateAdminBillingPortal = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createAdminBillingPortal>>, TError,void, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof createAdminBillingPortal>>,
        TError,
        void,
        TContext
      > => {
      return useMutation(getCreateAdminBillingPortalMutationOptions(options));
    }
